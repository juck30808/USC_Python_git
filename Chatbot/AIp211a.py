# AIp211a.py: AI practices - 11a > program a: a Chatbot example
# Jia-Sheng Heh, 11/29/2020, revised from AIp12c.py
...
# --> 部署的網址： https://aip211.herokuapp.com/   
###=== (4.5) 在部署Heroku時，同時偵錯 ===###  
# 建議 開設兩個 Terminals, 一個部署(如 4.4), 一個偵錯(如下行指令)
# $ heroku logs --tail --app aip211   (偵錯指令)
# 在 LINEBOT中, 以 WEBHOOK URL 進行連線測試
# 偵錯時，在程式碼中 加入 print()

#####===== (5) AIp211a.py =====##### ===> 網路簡易範例

###=== (5.0) 安裝軟件包 ===###  
### 在 PowerShell 中 下安裝指令: pip install line-bot-sdk
...
line_bot_api = LineBotApi("Zp/2/hfAYU42R5VzX9lipZWPs5GywkprPLzsg9loQGFtw28dWdmhRYhmAWHCvHPff3J9zboSUl/HvCxdK/1c3VGPmNkyckTn16oS+XIHwyh2F+Bty6bYHGF2+/CDYszqrH9ukdbgbmgqssohT+rWDgdB04t89/1O/w1cDnyilFU=")  #-- YOUR_CHANNEL_ACCESS_TOKEN
##== (2) Channel Secret
handler = WebhookHandler("6e7302556b6bf4ed2092818e2598ac8a")  #-- YOUR_CHANNEL_SECRET
